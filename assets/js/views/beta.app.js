...
beta.App = Backbone.View.extend({
    ...
    function count() {
      ...
      $('#days').html('<h2>' + days + '</h2><br><p>days</p><br>');
      $('#hours').html('<h2>' + hours + '</h2><br><p>hours</p><br>');
      $('#minutes').html('<h2>' + minutes + '</h2><br><p>minutes</p><br>');
      $('#seconds').html('<h2>' + seconds + '</h2><br><p>seconds</p><br>');
  }
